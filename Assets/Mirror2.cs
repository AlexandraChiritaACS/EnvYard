...
public class Mirror2 : MonoBehaviour
{
    ...
    void Update()
    {
        var position = SunPosition.CalculateSunPosition(DateTime.Now, latitude:1222222, longitude:322322);
    	float ang = (float) (position.Azimuth -  2.44346);
        textbox.text = "Angle mirror 2:" + ang;
